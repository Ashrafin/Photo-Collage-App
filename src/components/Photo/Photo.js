	...
	return (
		<div className="col-12 col-sm-6 col-md-4 col-lg-3 p-2 grid-item">
			<div className="image-wrapper">
				<img id="image" className="image" src={props.mediumImage} alt={props.photographer} />
				<ReactGallery source={image} />
				<a href={props.url} target="_blank" rel="noopener noreferrer" className="name-wrapper">
